...
-- ent1, priv1, telefono1, fecha1, valor1, 
...
-- nombre, apellido, tipo_identificacion, num_identificacion, caracter, capacidad_contratacion, juramento, legal
) 
...
VALUES (:rsocial, :nit, :sigla, :clase, :objectivoP, :ordenTipo, 
        ...
        -- :nombre, :apellido, :tipoId, :numId, :caracter, :capContratacion, :juramento, :legal
        )";
...
// $stmt->bindParam(':caracter', $_POST['juramento']);
